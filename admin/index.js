...
(function($PS) {
  "use strict";
  $PS["Admin.Main"] = $PS["Admin.Main"] || {};
  var exports = $PS["Admin.Main"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_List = $PS["Data.List"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var getEntity = (function () {
      var entity = Data_List.index(Node_Args.args)(0);
      var $0 = Data_Maybe.isNothing(entity);
      if ($0) {
  ...
  var fmt = function __do() {
      var cargoFormatCommand = Node_ChildProcess.spawn("cargo")([ "fmt" ])(Node_ChildProcess.defaultSpawnOptions)();
      Node_ChildProcess.onExit(cargoFormatCommand)(function (exit) {
      ...
      return Node_Stream.onData(Node_ChildProcess.stdout(cargoFormatCommand))(Control_Bind.composeKleisli(Effect.bindEffect)(Node_Buffer_Class.toString(Node_Buffer.mutableBufferEffect)(Node_Encoding.UTF8.value))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)))();
  };
